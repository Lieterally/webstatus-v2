...
@section('title', 'Edit Telegram Target')
...
@section('content')
    ...
    <div class="card bg-base-100 shadow-sm max-w-lg">
        <div class="card-body">
            <form method="POST" action="{{ route('telegram-targets.update', $telegramTarget) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-control mb-4">
                    ...
                    <input type="text" name="chat_id" id="chat_id"
                        value="{{ old('chat_id', $telegramTarget->chat_id) }}"
                ...
                <div class="form-control mb-4">
                    ...
                    <input type="text" name="username" id="username"
                        value="{{ old('username', $telegramTarget->username) }}"
                ...
                <div class="form-control mb-4" x-data="{ isActive: {{ old('is_active', $telegramTarget->is_active ? '1' : '0') == '1' ? 'true' : 'false' }} }">
                    <label class="label">
