<div wire:poll.2s="poll" x-data="{
    countdown: <?php if ((object) ('countdownSeconds') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('countdownSeconds'->value()); ?>')<?php echo e('countdownSeconds'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('countdownSeconds'); ?>')<?php endif; ?>,
    cycleInProgress: <?php if ((object) ('cycleInProgress') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('cycleInProgress'->value()); ?>')<?php echo e('cycleInProgress'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('cycleInProgress'); ?>')<?php endif; ?>,
    cycleIntervalSeconds: <?php if ((object) ('cycleIntervalSeconds') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('cycleIntervalSeconds'->value()); ?>')<?php echo e('cycleIntervalSeconds'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('cycleIntervalSeconds'); ?>')<?php endif; ?>,
    ...
    <div class="stats stats-vertical sm:stats-horizontal bg-base-100 shadow-sm w-full mb-6">
        ...
        <div class="stat">
            ...
            <div class="stat-value text-base-content"><?php echo e($totalSites); ?></div>
        </div>
        ...
        <div class="stat">
            ...
            <div class="stat-value text-error"><?php echo e($sitesDown); ?></div>
        </div>
        ...
        <div class="stat">
            ...
            <div class="stat-value text-success"><?php echo e($sitesUp); ?></div>
        </div>
        ...
        <div class="stat">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastCycleDatetime): ?>
                <div class="stat-value text-sm font-semibold"><?php echo e($lastCycleDatetime); ?></div>
            <?php else: ?>
        ...
        <div class="card-body">
                    ...
                    <div x-data="{
                        ...
                        init() {
                            this.tomSelect = new TomSelect(this.$refs.overviewSiteSelect, {
                                ...
                                onChange: (value) => {
                                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('overviewSiteFilter', value || null);
                                }
                            });
                        },
                        destroy() {
                        ...
                        <select x-ref="overviewSiteSelect" id="overviewSiteFilter">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allSites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($s->id); ?>"
                                    <?php echo e($overviewSiteFilter == $s->id ? 'selected' : ''); ?>>
                                    <?php echo e($s->name); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" wire:ignore>
                <div x-data="{
                    ...
                    createChart() {
                        const chartData = <?php echo \Illuminate\Support\Js::from($overviewChartData['response'])->toHtml() ?>;
                ...
                <div x-data="{
                    ...
                    createChart() {
                        const chartData = <?php echo \Illuminate\Support\Js::from($overviewChartData['downtime'])->toHtml() ?>;
                        this.createChartWithData(chartData);
                    },
                    createChartWithData(chartData) {
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span x-ref="totalLabel" class="badge badge-error badge-sm">
                            Total: <?php echo e($overviewChartData['downtime']['totalHours']); ?>h
                        </span>
                    </div>
                    <div class="bg-base-200/50 rounded-lg p-4" style="height: 280px;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedSiteId && $this->selectedSiteData): ?>
        <?php $siteData = $this->selectedSiteData; ?>
        <div class="card bg-base-100 shadow-sm mb-6 overflow-hidden" wire:ignore.self
            <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'site-detail-'.e($selectedSiteId).''; ?>wire:key="site-detail-<?php echo e($selectedSiteId); ?>" x-data="{
                responseChart: null,
                downtimeChart: null,
                ...
                createResponseTimeChart() {
                    ...
                    const chartData = <?php echo \Illuminate\Support\Js::from($siteData['responseTimeData'])->toHtml() ?>;
                ...
                createDowntimeChart() {
                    ...
                    const chartData = <?php echo \Illuminate\Support\Js::from($siteData['downtimeData'])->toHtml() ?>;
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-base-content"><?php echo e($siteData['site']->name); ?></h2>
                        <a href="<?php echo e($siteData['site']->base_url); ?>" target="_blank" rel="noopener noreferrer"
                            class="text-sm text-base-content/50 hover:text-primary hover:underline">
                            <?php echo e($siteData['site']->base_url); ?>
                ...
                <button wire:click="refreshSite(<?php echo e($siteData['site']->id); ?>)" wire:loading.attr="disabled"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siteData['downInfo']): ?>
                <div class="px-6 py-3 bg-error/10 border-b border-error/20">
                    <div class="flex flex-wrap items-center gap-4 text-sm">
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="font-semibold text-error"><?php echo e($siteData['downInfo']['first_down_at']); ?></span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <svg class="w-4 h-4 text-error" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span class="font-semibold text-error"><?php echo e($siteData['downInfo']['duration']); ?></span>
                        </div>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="px-6 py-4">
                ...
                <div class="overflow-x-auto">
                    <table class="table table-zebra table-sm">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $siteData['pageResults']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageResult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr>
                                    <td>
                                        <span class="text-base-content"><?php echo e($pageResult['path']); ?></span>
                                        
                                        <a href="<?php echo e($pageResult['full_url']); ?>" target="_blank"
                                            rel="noopener noreferrer"
                                            class="text-xs text-base-content/40 block hover:text-primary hover:underline">
                                            <?php echo e($pageResult['full_url']); ?>

                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pageResult['http_code'] === null): ?>
                                            <span class="text-base-content/40 italic">No data</span>
                                        <?php elseif($pageResult['http_code'] === 0): ?>
                                            <span class="badge badge-error badge-sm">
                                                Unreachable
                                            </span>
                                        <?php elseif($pageResult['http_code'] >= 200 && $pageResult['http_code'] < 400): ?>
                                            <span class="badge badge-success badge-sm">
                                                <?php echo e($pageResult['http_code']); ?>
                                    ...
                                    <td class="text-right">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pageResult['response_time_ms'] !== null && $pageResult['http_code'] > 0): ?>
                                            <span
                                                class="font-mono text-base-content/70"><?php echo e(number_format($pageResult['response_time_ms'], 0)); ?>
                                    ...
                                    <td class="text-right text-base-content/50">
                                        <?php echo e($pageResult['checked_at'] ?? '—'); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-3">
                            <h3 class="text-sm font-semibold text-base-content/70">Downtime (Last 30 Days)</h3>
                            <span class="badge badge-error badge-sm">
                                Total: <?php echo e($siteData['downtimeData']['totalHours']); ?>h
                            </span>
                        </div>
                        <div class="bg-base-200/50 rounded-lg p-4" style="height: 280px;">
            ...
            <div class="px-6 py-4 border-t border-base-200">
                ...
                <div class="overflow-x-auto">
                    <table class="table table-zebra table-sm">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $siteData['downtimeHistory']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $outage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td class="font-mono text-xs"><?php echo e($outage['from']); ?></td>
                                    <td class="font-mono text-xs">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($outage['to'] === 'Ongoing'): ?>
                                            <span class="badge badge-error badge-xs">Ongoing</span>
                                        <?php else: ?>
                                            <?php echo e($outage['to']); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td class="text-xs"><?php echo e($outage['pages']); ?></td>
                                    <td class="font-semibold text-xs"><?php echo e($outage['duration']); ?></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <tr>
    ...
    <div class="card bg-base-100 shadow-sm">
                ...
                <div class="flex items-center gap-3 flex-wrap lg:flex-nowrap w-full lg:w-auto">
                    ...
                    <div class="join">
                        <button wire:click="$set('viewMode', 'card')"
                            class="join-item btn btn-sm <?php echo e($viewMode === 'card' ? 'btn-primary' : 'btn-ghost'); ?>">
                            Card
                        </button>
                        <button wire:click="$set('viewMode', 'table')"
                            class="join-item btn btn-sm <?php echo e($viewMode === 'table' ? 'btn-primary' : 'btn-ghost'); ?>">
                            Table
                        </button>
                    </div>
                </div>
        ...
        <div class="card-body pt-0">
            ...
            <?php elseif($viewMode === 'card'): ?>
                ...
                <div
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        ?>
                        <div wire:click="selectSite(<?php echo e($site->id); ?>)"
                            class="card bg-base-100 shadow-sm border-l-4 <?php echo e($cardBorder); ?> p-3 cursor-pointer hover:shadow-md transition-shadow">
                            <p class="text-xs font-semibold text-base-content truncate" title="<?php echo e($site->name); ?>">
                                <?php echo e($site->name); ?></p>
                            <span class="badge <?php echo e($cardBadge); ?> badge-xs mt-1.5">
                                <?php echo e($cardStatusText); ?>

                            </span>
                            <?php $cardAvgTime = $siteMetrics[$site->id]['avg_response_time_24h'] ?? 0; ?>
                            <p class="text-[10px] text-base-content/50 mt-1">
                                <?php echo e($cardAvgTime > 0 ? number_format($cardAvgTime, 0) . ' ms' : '—'); ?>

                            </p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($site->responsiblePerson): ?>
                                <p class="text-[10px] text-base-content/40 mt-0.5 truncate"
                                    title="<?php echo e($site->responsiblePerson->name); ?>"><?php echo e($site->responsiblePerson->name); ?>
                    ...
                    <table class="table table-zebra table-sm">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                ?>
                                <tr wire:click="selectSite(<?php echo e($site->id); ?>)" class="cursor-pointer hover">
                                    <td class="font-medium text-base-content"><?php echo e($site->name); ?></td>
                                    <td class="text-center">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($httpCode !== null): ?>
                                            <span
                                                class="font-mono text-sm <?php echo e($httpCode >= 200 && $httpCode < 400 ? 'text-success' : 'text-error'); ?>">
                                                <?php echo e($httpCode); ?>
                                    ...
                                    <td class="text-center">
                                        <span class="badge <?php echo e($tableBadge); ?> badge-sm">
                                            <?php echo e($tableStatusText); ?>

                                        </span>
                                    </td>
                                    <td class="text-right font-mono text-base-content/70">
                                        <?php echo e($avgTime24h > 0 ? number_format($avgTime24h, 0) . ' ms' : '—'); ?>

                                    </td>
                                    <td class="text-base-content/60">
                                        <?php echo e($site->responsiblePerson?->name ?? '—'); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sites->hasPages()): ?>
                <div class="mt-4">
                    <?php echo e($sites->links('vendor.livewire.daisy-pagination')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showLogDrawer): ?>
            ...
            <div x-ref="logPanel"
                ...
                <div class="flex items-center justify-between px-4 py-3 border-b border-base-200 bg-base-200/50">
                    <div class="flex items-center gap-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->cycleTotalPages > 0): ?>
                            <span class="badge badge-sm badge-ghost">
                                <?php echo e(count($this->cycleLogs)); ?> / <?php echo e($this->cycleTotalPages); ?>

                            </span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cycleInProgress || $isRefreshing): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->cycleTotalPages > 0): ?>
                    ...
                    ?>
                    <div class="px-4 pt-2">
                        <progress class="progress progress-primary w-full" value="<?php echo e($progress); ?>"
                            max="100"></progress>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex-1 overflow-y-auto px-4 py-2 space-y-1" x-data x-init="$nextTick(() => $el.scrollTop = $el.scrollHeight)"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->cycleLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="flex items-center gap-2 py-1 border-b border-base-200/50 text-xs">
                            <span class="text-base-content/40 font-mono shrink-0"><?php echo e($log['time']); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log['http_code'] === 0): ?>
                                <span class="badge badge-error badge-xs shrink-0">ERR</span>
                            <?php elseif($log['http_code'] >= 200 && $log['http_code'] < 400): ?>
                                <span class="badge badge-success badge-xs shrink-0"><?php echo e($log['http_code']); ?></span>
                            <?php else: ?>
                                <span class="badge badge-error badge-xs shrink-0"><?php echo e($log['http_code']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <span class="font-medium text-base-content truncate shrink-0 max-w-[120px]"
                                title="<?php echo e($log['site']); ?>"><?php echo e($log['site']); ?></span>
                            <span class="text-base-content/50 truncate"
                                title="<?php echo e($log['url']); ?>"><?php echo e(parse_url($log['url'], PHP_URL_PATH) ?: '/'); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log['http_code'] > 0 && $log['response_time_ms'] > 0): ?>
                                <span
                                    class="text-base-content/40 font-mono ml-auto shrink-0"><?php echo e(number_format($log['response_time_ms'], 0)); ?>ms</span>
                            <?php elseif($log['http_code'] === 0): ?>
                                <span class="text-error/70 ml-auto shrink-0"><?php echo e($log['error_type']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php /**PATH D:\laragon\www\webstatus-v2\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>