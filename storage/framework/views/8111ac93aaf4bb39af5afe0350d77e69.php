...
<?php $__env->startSection('title', 'Website Manager'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card bg-base-100 shadow-sm mb-4">
        <div class="card-body py-3">
            <form method="GET" action="<?php echo e(route('sites.index')); ?>" class="flex flex-wrap items-center gap-3">
                
                <label class="input input-sm input-bordered flex items-center gap-2 w-auto sm:w-64">
                    <i class="fa-solid fa-magnifying-glass"></i>
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search site name..."
                        class="grow">
                </label>
                ...
                <select name="person" class="select select-sm select-bordered w-auto sm:w-auto">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($staff->id); ?>" <?php echo e(request('person') == $staff->id ? 'selected' : ''); ?>>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search') || request('category') || request('person')): ?>
                    <a href="<?php echo e(route('sites.index')); ?>" class="btn btn-sm btn-ghost">Clear</a>
        ...
        <div class="card-body p-0">
            <div class="overflow-x-auto">
                <table class="table table-zebra">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover">
                                <td class="font-medium"><?php echo e($site->name); ?></td>
                                <td><?php echo e($site->category->name); ?></td>
                                <td>
                                    <a href="<?php echo e($site->base_url); ?>" target="_blank"
                                        class="link link-primary"><?php echo e($site->base_url); ?></a>
                                </td>
                                <td>
                                    <div class="tooltip tooltip-right"
                                        data-tip="<?php echo e($site->pages->pluck('path')->join(', ')); ?>">
                                        <span
                                            class="cursor-help underline decoration-dotted"><?php echo e($site->pages_count); ?></span>
                                    </div>
                                </td>
                                <td><?php echo e($site->responsiblePerson->name); ?></td>
                                <td class="text-right space-x-2">
                                    <a href="<?php echo e(route('sites.edit', $site)); ?>" class="btn btn-ghost btn-sm">Edit</a>
                                    <button type="button"
                                        @click="openModal('<?php echo e($site->name); ?>', '<?php echo e(route('sites.destroy', $site)); ?>')"
                ...
                <div class="row p-4">
                    ...
                    <?php echo e($sites->links('vendor.pagination.daisy')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\webstatus-v2\resources\views/sites/index.blade.php ENDPATH**/ ?>